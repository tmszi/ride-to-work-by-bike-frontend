...
describe('<FormFieldBusinessId>', () => {
  ...
  context('desktop', () => {
    ...
    it('validates registration number correctly', () => {
      ...
      cy.dataCy('form-business-id-input').type('8765432');
      cy.dataCy('form-business-id-input').blur();
      ...
      // invalid registration number
      cy.dataCy('form-business-id-input').type('1234567890');
      cy.dataCy('form-business-id-input').blur();
      cy.dataCy('form-vat-id')
        .find('.q-field__messages')
        .should('be.visible')
      ...
      cy.dataCy('form-business-id-input').clear();
      // invalid registration number
      cy.dataCy('form-business-id-input').type('8765432a');
      cy.dataCy('form-business-id-input').blur();
      cy.dataCy('form-vat-id')
        .find('.q-field__messages')
        .should('be.visible')
      ...
      cy.dataCy('form-business-id-input').type('08765432');
      cy.dataCy('form-business-id-input').blur();
      cy.get('.q-field__messages').should('be.empty');
      cy.dataCy('form-business-id-input').clear();
      // valid registration number
      cy.dataCy('form-business-id-input').type('87654321');
      cy.dataCy('form-business-id-input').blur();
      cy.get('.q-field__messages').should('be.empty');
    });
  });
